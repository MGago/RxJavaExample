package com.example.mariogago.rxjavaexample;
...
public class GitHubRepoAdapter extends BaseAdapter {
    ...
    private static class GitHubRepoViewHolder {
        ...
        public GitHubRepoViewHolder(View view) {
            this.textRepoName = (TextView) view.findViewById(R.id.text_repo_name);
            this.textRepoDescription = (TextView) view.findViewById(R.id.text_repo_description);
            this.textLanguage = (TextView) view.findViewById(R.id.text_language);
            this.textStars = (TextView) view.findViewById(R.id.text_stars);
        }
        ...
        public void setGitHubRepo(GitHubRepo gitHubRepo) {
            ...
            textStars.setText(Integer.toString(gitHubRepo.stargazersCount));
        }
    }
}
